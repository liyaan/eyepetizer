...
import 'package:eyepetizer/page/center/oneself_center.dart';
...
class _TabNavigationState extends State<TabNavigation> {
  ...
  int _currentIndex = 0;
  TabNavigationViewModel tabModel;
  @override
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body: PageView(
          ...
          onPageChanged: (index){
            print("$index");
            tabModel.changeBottomTabIndex(index);
          },
  ...
  Future<bool> _onWillPop() async {
    if (lastTime == null ||
      ...
      ToastUtils.showTip(LeoString.exit_tip);
      return false;
    } else {
      return true;
    }
